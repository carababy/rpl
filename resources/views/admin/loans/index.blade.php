            ...
            <table class=" table table-bordered table-striped table-hover datatable datatable-Income">
                <thead>
                    <tr>
                        ...
                        <th>
                            {{ trans('cruds.loan.fields.borrower') }}
                        </th>
                        <th>
                            {{ trans('cruds.loan.fields.g_name') }}
                        </th>
                        <th>
                            {{ trans('cruds.loan.fields.loan_status') }}
                        </th>
                        <th>
                            &nbsp;
                        </th>
                ...
                <tbody>
                    @foreach($loans as $key => $loan)
                        <tr data-entry-id="{{ $loan->id }}">
                            ...
                            <td>
                                @can('income_show')
                                    <a class="btn btn-xs btn-primary" href="{{ route('admin.loans.show', $income->id) }}">
                                        {{ trans('global.view') }}
                                    </a>
                                @endcan

                                @can('income_edit')
                                    <a class="btn btn-xs btn-info" href="{{ route('admin.loans.edit', $income->id) }}">
                                        {{ trans('global.edit') }}
                                    </a>
                                @endcan
