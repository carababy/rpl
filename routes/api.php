...
Route::group(['prefix' => 'v1', 'as' => 'api.', 'namespace' => 'Api\V1\Admin', 'middleware' => ['auth:api']], function () {
    ...
    // Aroc Centers
    Route::apiResource('aroc-centers', 'ArocCenterApiController');

    // Genders
    Route::apiResource('genders', 'GenderApiController');

    // Queries
    Route::post('queries/media', 'QueryApiController@storeMedia')->name('queries.storeMedia');
